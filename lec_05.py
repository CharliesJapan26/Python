...
data= pd.Series([0.25, 0.5, 0.7, 1.0], index=['a', 'b', 'c', 'd'])
print(data)
...
data= pd.Series([0.25, 0.5, 0.7, 1.0], index=[1,10,7, 'd'])
print(data)
...
#index - способ сослаться на данные в series или dataframe
...
print(df.['dicr_01'])#столбец
print(df.values[0])#строка


print(df)

print(df.loc['A':'C', :'dict_02'])#назв ключей
print(dfiloc[:3,:2])#индексы

print(df.loc[df.dict_02>30,['new1','dict_01']])
print(df.loc[df.dict_02>30,['new1','dict_01']])=36
print(df)
...
dr=pd:DataFrame(rng.integers(0,10(3,4)),columns=['A','B','C','D'])
print(df)
...
print(data_dict1.add(data_dict2,fill value=5))
...
df=pd.DataFrame({'dict_01':data_dict1,'dict_02':data_dict2})
print(df)
df=pd.DataFrame({'dict_10':data_dict1,'dict_02':data_dict2})
print(df1)

print(df+df1)
print(df.add(df1,fill_values.sum()))
